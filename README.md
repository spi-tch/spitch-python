...
> [!NOTE]
> Once this package is [published to PyPI](https://app.stainlessapi.com/docs/guides/publish), this will become: `pip install spitch`
...
You can enable logging by setting the environment variable `SPITCH_LOG` to `debug`.

```shell
$ export SPITCH_LOG=debug
```
